                ...
                <div className="right-box margin-bottom">
                    <div className="infoBox margin-bottom">
                        ...
                        <div className="skills-meter-background">
                            <div className="skills-meter-foreground" style={{width:"90%"}}>90%</div>
                        </div>
                        ...
                        <p>Problem Solving</p>
                        <div className="skills-meter-background">
                            <div className="skills-meter-foreground" style={{width:"85%"}}>85%</div>
                        </div>
                        ...
                        <p>Teamwork</p>
                        <div className="skills-meter-background">
                            <div className="skills-meter-foreground" style={{width:"80%"}}>80%</div>
                        </div>
                ...
                <div className="right-box margin-bottom">
                    <div className="infoBox margin-bottom">
                        <h5 className="icon-grey">
                            ...
                            <p>Teaching</p>
                            <div className="skills-meter-background">
                                <div className="skills-meter-foreground" style={{width:"85%"}}>80%</div>
                            </div>
                            ...
                            <p>Data Analysis</p>
                            <div className="skills-meter-background">
                                <div className="skills-meter-foreground" style={{width:"75%"}}>85%</div>
                            </div>

                            <p>Photography</p>
                            <div className="skills-meter-background">
                                <div className="skills-meter-foreground" style={{width:"75%"}}>80%</div>
                            </div>
