        ...
        <div className="col-md-4 float-left" >
            <div className="contentBox">
                ...
                <div className="infoBox padding-bottom margin-bottom">
                    ...
                    <p>Node</p>
                    <div className="skills-meter-background">
                        <div className="skills-meter-foreground" style={{width:"55%"}}>55%</div>
                    </div>
                    
                    <p>MongoDB</p>
                    <div className="skills-meter-background">
                        <div className="skills-meter-foreground" style={{width:"50%"}}>50%</div>
                    </div>
                    ...
                    <p>English</p>
                    <div className="skills-meter-background">
                        <div className="skills-meter-foreground"style={{width:"100%",height:"24px"}}></div>
                    </div>

                    <p>French</p>
                    <div className="skills-meter-background">
                        <div className="skills-meter-foreground"style={{width:"50%",height:"24px"}}></div>
                    </div>
                    <br></br>
                </div>
            </div>
