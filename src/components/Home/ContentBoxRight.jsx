...
function ContentBoxRight(){
    return (
        ...
        <div className="right-box margin-bottom">
            ...
            <p>
            Gaining experience and building my portfolio.  Focusing on building my knowledge of all relevant frameworks and working towards my goal of being a professional Full Stack Developer.
            </p>
            <hr></hr>
            </div>
            ...
            <p>
            705 Operation, conducting scheduled flights for Porter Airlines as a First Officer on the Q400            </p>
            <hr></hr>
            </div>
            ...
            <p>
            703 Operation, conducted medevac flights as a first officer on the King Air 200.            </p>
            <hr></hr>
            </div>
            ...
            <p>
            Conducted over 1100 hours of flight instruction in various departments and managed a team of flight instructors to ensure student learning and outcomes were maximized within strict training deadlines.            </p>
            </div>
        ...
        <h2 className="padding-16 icon-grey">
            ...
            <p>
            Completed over 60 hours of online learning, developing fundamental skills required to become a full stack web developer.
            </p>
            <hr></hr>
            </div>
            ...
            <p>
            Graduated with a 3.6 GPA. Simultaneously acquired my BSc. and Commerial Pilot Licence.  Academic focus on Aviation and Environmental Science   
            </p>
            </div>
